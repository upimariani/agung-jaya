...
class cAnalisis extends CI_Controller
{
	...
	{
		$data = array(
			'analisis' => $this->mAnalisis->analisis_member()
		);
		$this->load->view('Admin/Layout/head');
		$this->load->view('Admin/Layout/aside');
		$this->load->view('Admin/Analisis/vAnalisisMember', $data);
		$this->load->view('Admin/Layout/footer', $data);
	}
	...
	{
		$data = array(
			'produk_terjual' => $this->mAnalisis->produk_terjual()
		);
		$this->load->view('Admin/Layout/head');
		$this->load->view('Admin/Layout/aside');
		$this->load->view('Admin/Analisis/vProdukTerjual', $data);
		$this->load->view('Admin/Layout/footer');
	}
}
